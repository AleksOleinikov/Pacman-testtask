...
public class ConditionalHideAttribute : PropertyAttribute
{
    ...
    public int [] ConditionalComparison;
    ...
    public ConditionalHideAttribute(string conditionalSourceField, int [] conditionalComparison, bool hideInInspector)
    {
        this.ConditionalSourceField = conditionalSourceField.ToString();
        this.HideInInspector = hideInInspector;
